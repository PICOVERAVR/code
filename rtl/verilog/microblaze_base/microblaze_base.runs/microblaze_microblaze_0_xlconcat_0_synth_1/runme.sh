...
HD_PWD='C:/Users/kyle/Desktop/dev/main/rtl/verilog/microblaze_base/microblaze_base.runs/microblaze_microblaze_0_xlconcat_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_microblaze_0_xlconcat_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_microblaze_0_xlconcat_0.tcl
