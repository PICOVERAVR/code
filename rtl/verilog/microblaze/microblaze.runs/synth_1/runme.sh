...
HD_PWD='C:/Users/kyle/Desktop/dev/main/rtl/verilog/microblaze/microblaze.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_design_wrapper.tcl
