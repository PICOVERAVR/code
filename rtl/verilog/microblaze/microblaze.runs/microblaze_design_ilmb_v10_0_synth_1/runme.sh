...
HD_PWD='C:/Users/kyle/Desktop/dev/main/rtl/verilog/microblaze/microblaze.runs/microblaze_design_ilmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_design_ilmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_design_ilmb_v10_0.tcl
