...
ISEStep( "vivado",
         "-log microblaze_design_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_design_ilmb_bram_if_cntlr_0.tcl" );
