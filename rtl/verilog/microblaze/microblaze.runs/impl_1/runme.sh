...
HD_PWD='C:/Users/kyle/Desktop/dev/main/rtl/verilog/microblaze/microblaze.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microblaze_design_wrapper.tcl -notrace
